...
public:
  ...
  ALU2dGridEntity( const FactoryType& factory,
  ...
  */
  ...
  const GridImp& grid() const { return factory().grid(); }

  //! return reference to factory
  const FactoryType& factory() const { alugrid_assert( factory_ ); return *factory_; }
...
public:
  ...
  //! tpye of entitypointer implementation
  ...
  */
  ...
  {
    return ALU2dGridLevelIntersectionIteratorType( factory(), *this, this->level(),false);
  }
  ALU2dGridLevelIntersectionIteratorType ilevelend () const
  {
    return ALU2dGridLevelIntersectionIteratorType( factory(), *this, this->level(),true);
  }
  ALU2dGridLeafIntersectionIteratorType ileafbegin () const
  {
    return ALU2dGridLeafIntersectionIteratorType( factory(), *this, this->level(), false);
  }
  ALU2dGridLeafIntersectionIteratorType ileafend () const
  {
    return ALU2dGridLeafIntersectionIteratorType( factory(), *this, this->level(),true);
  }
