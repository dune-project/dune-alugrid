...
namespace Dune
{
  ...
  public:
    //! default constructor
    ALU2dGridIntersectionBase () : factory_( nullptr ) {}

    //! creating an empty ALU2dGridIntersectionIterator
  ...
  public:
    ...
    //! createing an empty ALU2dGridIntersectionIterator
    ALU2dGridLeafIntersectionIterator(const FactoryType& factory, int wLevel);

    //! level tells on which level we want neighbours
