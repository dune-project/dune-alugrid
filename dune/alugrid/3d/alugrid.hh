...
namespace Dune
{
  ...
  */
  template<int dimw, ALUGridElementType elType, ALUGridRefinementType refineType, class Comm >
  class ALUGrid< 2, dimw, elType, refineType, Comm >
   : public ALUGridBaseGrid < 2, dimw, elType, Comm > :: BaseGrid
  {
    typedef ALUGrid< 2, dimw, elType, refineType, Comm > This;
