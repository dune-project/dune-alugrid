...
namespace Dune
{
  ...
  typename ALU3dGridSurfaceMappingFactory< dim, dimw, tetra, Comm >::SurfaceMappingType *
  ALU3dGridSurfaceMappingFactory< dim, dimw, tetra, Comm >::buildSurfaceMapping ( const CoordinateType &coords ) const
  {
  ...
  template< int dim, int dimw, class Comm >
  typename ALU3dGridSurfaceMappingFactory< dim, dimw, hexa, Comm >::SurfaceMappingType *
  ALU3dGridSurfaceMappingFactory< dim, dimw, hexa, Comm >::buildSurfaceMapping ( const CoordinateType &coords ) const
  {
  ...
  template< int dim, int dimw, class Comm >
  typename ALU3dGridSurfaceMappingFactory< dim, dimw, tetra, Comm >::SurfaceMappingType *
  ALU3dGridSurfaceMappingFactory< dim, dimw, tetra, Comm >::buildSurfaceMapping ( const GEOFaceType &face ) const
  {
  ...
  template< int dim, int dimw, class Comm >
  typename ALU3dGridSurfaceMappingFactory< dim, dimw, hexa, Comm >::SurfaceMappingType *
  ALU3dGridSurfaceMappingFactory< dim, dimw, hexa, Comm >::buildSurfaceMapping ( const GEOFaceType &face ) const
  {
